module "lab2-instances" {
  ...
  manager_name           = "r-manager"        # instance names will end with instancecount #does not like "_"
  ...
  worker_name           = "r-worker"         # instance names will end with instance_count
